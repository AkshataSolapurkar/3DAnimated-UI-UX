## Some Learnings 
All the 3D Models are Quite Huge so it Has tobe Compressed into smaller size
It's is Done By using gltf.jsx tool
![Compression of the 3D Model,And converting the gltf into jsx component](https://github.com/pmndrs/gltfjsx)
3D Model Downloaded by SketchFab
![Download the 3D Model from](https://t.co/vqUyyGZK85)
